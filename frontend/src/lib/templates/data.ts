...
export const sheetTemplates: SheetTemplate[] = [
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '산출근거', type: 'general' as ColumnType, width: 300, exportName: 'formula' },
      { name: '영향범위', type: 'general' as ColumnType, width: 200, exportName: 'affectedRange' },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: 'EHP', type: 'formula' as ColumnType, width: 90, exportName: 'ehp' },
      { name: 'DPS', type: 'formula' as ColumnType, width: 90, exportName: 'dps' },
      { name: '설계의도', type: 'general' as ColumnType, width: 280, exportName: 'designNote' },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '설계의도', type: 'general' as ColumnType, width: 250, exportName: 'designNote' },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '기준값근거', type: 'general' as ColumnType, width: 150, exportName: 'baseValueNote' },
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: 'TTK목표', type: 'general' as ColumnType, width: 70, exportName: 'targetTtk' },
      { name: '설계의도', type: 'general' as ColumnType, width: 280, exportName: 'designNote' },
    ],
    sampleRows: [
      {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '가정조건', type: 'general' as ColumnType, width: 150, exportName: 'assumption' },
      { name: '설계의도', type: 'general' as ColumnType, width: 200, exportName: 'designNote' },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '설계의도', type: 'general' as ColumnType, width: 220, exportName: 'designNote' },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '설계의도', type: 'general' as ColumnType, width: 230, exportName: 'designNote' },
    ],
    sampleRows: [
      {
        cells: {
