...
export const sheetTemplates: SheetTemplate[] = [
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '단위', type: 'text' as ColumnType, width: 60 },
      { name: '산출근거', type: 'text' as ColumnType, width: 300 },
      { name: '영향범위', type: 'text' as ColumnType, width: 200 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '역할', type: 'text' as ColumnType, width: 70 },
      { name: 'HP배율', type: 'number' as ColumnType, width: 70 },
      { name: 'HP', type: 'formula' as ColumnType, width: 90 },
      { name: 'ATK배율', type: 'number' as ColumnType, width: 75 },
      { name: 'ATK', type: 'formula' as ColumnType, width: 90 },
      { name: 'DEF배율', type: 'number' as ColumnType, width: 75 },
      { name: 'DEF', type: 'formula' as ColumnType, width: 90 },
      { name: 'CritRate', type: 'number' as ColumnType, width: 75 },
      { name: 'CritDMG', type: 'number' as ColumnType, width: 75 },
      { name: 'EHP', type: 'formula' as ColumnType, width: 90 },
      { name: 'DPS', type: 'formula' as ColumnType, width: 90 },
      { name: '설계의도', type: 'text' as ColumnType, width: 280 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '스킬명', type: 'text' as ColumnType, width: 110 },
      { name: '타입', type: 'text' as ColumnType, width: 70 },
      { name: '배율(%)', type: 'number' as ColumnType, width: 75 },
      { name: '쿨타임(s)', type: 'number' as ColumnType, width: 80 },
      { name: '마나', type: 'number' as ColumnType, width: 60 },
      { name: '대상수', type: 'number' as ColumnType, width: 65 },
      { name: '스킬DPS', type: 'formula' as ColumnType, width: 90 },
      { name: '효과', type: 'text' as ColumnType, width: 120 },
      { name: '설계의도', type: 'text' as ColumnType, width: 250 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '이름', type: 'text' as ColumnType, width: 110 },
      { name: '타입', type: 'text' as ColumnType, width: 65 },
      { name: '등급', type: 'text' as ColumnType, width: 50 },
      { name: '등급배율', type: 'number' as ColumnType, width: 75 },
      { name: '기준값', type: 'number' as ColumnType, width: 70 },
      { name: '기준값근거', type: 'text' as ColumnType, width: 150 },
      { name: '주스탯', type: 'text' as ColumnType, width: 65 },
      { name: '주스탯값', type: 'formula' as ColumnType, width: 90 },
      { name: '부스탯', type: 'text' as ColumnType, width: 65 },
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '이름', type: 'text' as ColumnType, width: 100 },
      { name: '타입', type: 'text' as ColumnType, width: 60 },
      { name: '레벨', type: 'number' as ColumnType, width: 55 },
      { name: 'HP배율', type: 'number' as ColumnType, width: 70 },
      { name: 'HP', type: 'formula' as ColumnType, width: 100 },
      { name: 'ATK배율', type: 'number' as ColumnType, width: 75 },
      { name: 'ATK', type: 'formula' as ColumnType, width: 90 },
      { name: 'DEF', type: 'formula' as ColumnType, width: 80 },
      { name: 'EXP기준', type: 'number' as ColumnType, width: 75 },
      { name: 'EXP', type: 'formula' as ColumnType, width: 90 },
      { name: '골드기준', type: 'number' as ColumnType, width: 75 },
      { name: '골드', type: 'formula' as ColumnType, width: 90 },
      { name: 'TTK목표', type: 'number' as ColumnType, width: 70 },
      { name: '설계의도', type: 'text' as ColumnType, width: 280 },
    ],
    sampleRows: [
      {
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '무기명', type: 'text' as ColumnType, width: 110 },
      { name: '타입', type: 'text' as ColumnType, width: 80 },
      { name: '데미지', type: 'number' as ColumnType, width: 70 },
      { name: 'RPM', type: 'number' as ColumnType, width: 65 },
      { name: '탄창', type: 'number' as ColumnType, width: 55 },
      ...
      { name: '역할', type: 'text' as ColumnType, width: 100 },
      { name: '설계의도', type: 'text' as ColumnType, width: 250 },
    ],
    sampleRows: [
      {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '레벨', type: 'number' as ColumnType, width: 55 },
      { name: '효과기준', type: 'number' as ColumnType, width: 75 },
      { name: '효과', type: 'formula' as ColumnType, width: 100 },
      { name: '효과단위', type: 'text' as ColumnType, width: 90 },
      { name: '비용기준', type: 'number' as ColumnType, width: 75 },
      { name: '비용증가율', type: 'number' as ColumnType, width: 85 },
  ...
  // ========================================
  {
    ...
    columns: [
      { name: '등급', type: 'text' as ColumnType, width: 70 },
      { name: '기본확률(%)', type: 'number' as ColumnType, width: 95 },
      { name: '기대뽑수', type: 'formula' as ColumnType, width: 90 },
      { name: '소프트천장', type: 'number' as ColumnType, width: 90 },
      { name: '하드천장', type: 'number' as ColumnType, width: 85 },
      { name: '천장증가율', type: 'number' as ColumnType, width: 90 },
      { name: '실제기대뽑수', type: 'number' as ColumnType, width: 100 },
      { name: '1뽑당비용', type: 'number' as ColumnType, width: 90 },
  ...
  // ========================================
  {
    ...
    columns: [
      { name: '항목', type: 'text' as ColumnType, width: 130 },
      { name: 'F/S', type: 'text' as ColumnType, width: 50 },
      { name: '재화', type: 'text' as ColumnType, width: 70 },
      { name: '일일량', type: 'number' as ColumnType, width: 90 },
      { name: '주간량', type: 'formula' as ColumnType, width: 90 },
      { name: '총Faucet', type: 'number' as ColumnType, width: 85 },
      { name: '비율(%)', type: 'formula' as ColumnType, width: 100 },
      { name: '가정조건', type: 'text' as ColumnType, width: 150 },
      { name: '설계의도', type: 'text' as ColumnType, width: 200 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      { name: '웨이브', type: 'number' as ColumnType, width: 65 },
      { name: '타입', type: 'text' as ColumnType, width: 70 },
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '이름', type: 'text' as ColumnType, width: 110 },
      { name: '등급', type: 'text' as ColumnType, width: 60 },
      { name: '등급배율', type: 'number' as ColumnType, width: 80 },
      { name: '효과타입', type: 'text' as ColumnType, width: 90 },
      { name: '효과값', type: 'formula' as ColumnType, width: 100 },
      { name: '효과근거', type: 'text' as ColumnType, width: 150 },
      { name: '시너지태그', type: 'text' as ColumnType, width: 80 },
      { name: '시너지조건', type: 'text' as ColumnType, width: 90 },
      { name: '시너지효과', type: 'text' as ColumnType, width: 130 },
      { name: '설계의도', type: 'text' as ColumnType, width: 220 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '카드명', type: 'text' as ColumnType, width: 110 },
      { name: '등급', type: 'text' as ColumnType, width: 60 },
      { name: '타입', type: 'text' as ColumnType, width: 65 },
      { name: '코스트', type: 'number' as ColumnType, width: 60 },
      { name: '데미지', type: 'number' as ColumnType, width: 65 },
      { name: '방어도', type: 'number' as ColumnType, width: 65 },
      { name: '효율', type: 'formula' as ColumnType, width: 75 },
      { name: '추가효과', type: 'text' as ColumnType, width: 130 },
      { name: '설계의도', type: 'text' as ColumnType, width: 230 },
    ],
    sampleRows: [
      {
        cells: {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: '소스레벨', type: 'number' as ColumnType, width: 80 },
      { name: '아이템', type: 'text' as ColumnType, width: 110 },
      { name: '확률(%)', type: 'number' as ColumnType, width: 75 },
      { name: '최소', type: 'number' as ColumnType, width: 55 },
      { name: '최대', type: 'number' as ColumnType, width: 55 },
      { name: '기대값', type: 'formula' as ColumnType, width: 80 },
      { name: '클리어시간(초)', type: 'number' as ColumnType, width: 105 },
  ...
  // ========================================
  {
    ...
    columns: [
      { name: 'ID', type: 'text' as ColumnType, width: 80 },
      { name: '재화명', type: 'text' as ColumnType, width: 90 },
      { name: '타입', type: 'text' as ColumnType, width: 70 },
      { name: '최대보유', type: 'number' as ColumnType, width: 100 },
      { name: '주획득경로', type: 'text' as ColumnType, width: 140 },
      { name: '주소비처', type: 'text' as ColumnType, width: 140 },
      { name: '일일획득량', type: 'number' as ColumnType, width: 95 },
      { name: '설계의도', type: 'text' as ColumnType, width: 250 },
    ],
    sampleRows: [
      {
  ...
  // ========================================
  {
    ...
    columns: [
      ...
      { name: 'HP성장', type: 'number' as ColumnType, width: 75 },
      { name: 'HP(18렙)', type: 'formula' as ColumnType, width: 90 },
      { name: 'AD(1렙)', type: 'number' as ColumnType, width: 75 },
      { name: 'AD성장', type: 'number' as ColumnType, width: 75 },
  ...
  // ========================================
  {
    ...
    columns: [
      { name: '환생횟수', type: 'number' as ColumnType, width: 85 },
      { name: '필요조건', type: 'text' as ColumnType, width: 140 },
      { name: '예상소요시간', type: 'text' as ColumnType, width: 100 },
      { name: '데미지배율', type: 'number' as ColumnType, width: 95 },
